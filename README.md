...
> [!NOTE]
> The [`Set-Alias`](https://go.microsoft.com/fwlink/?LinkID=2096625) command statement is rejected as aliases should be avoided for private functions
...
The [`Install-Module`](https://go.microsoft.com/fwlink/?LinkID=398573) cmdlet is rejected along with other cmdlet commands, to specify scripts that
run in the module's session state, use the `NestedModules` manifest setting.

### New-Type

The [New-Type](#new-type) cmdlet is rejected along with other cmdlet commands, to load any assembly or type
...
* [#18740: Best practice: import functions in a module](https://github.com/PowerShell/PowerShell/issues/18740)
...
* [#6652:Various PowerShell Class Issues](https://github.com/PowerShell/PowerShell/issues/6652)
* [#24253: Add ScriptsToInclude to the Module Manifest](https://github.com/PowerShell/PowerShell/issues/24253)
